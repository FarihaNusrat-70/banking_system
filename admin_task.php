...
<body>
	...
	<section>
		...
		<nav>
			<ul class="top-left">
			  ...
			  <li> <a ><i class="fa fa-envelope"></i> fariha35-2670@diu.edu.bd.com</a></li>
			</ul>
			<ul  class="top-right">
				<li >
	...
	<section class="top-bg1">
	    ...
	    <form action="admin_task.php" method="post" style="padding: 0 11%;">
	    	...
	    	<input style="border-radius:6px ; background: #006666; color: white;" type="submit" name="submit" value = "Search">
	    </form>
							...
							<div class="container-fluid">
								<form action="admin_edit_done.php" method="post">
									...
									<div class="create_btn">
										...
										<input style="border-radius:6px ; background: #006666; color: white;" type="submit" class="btnSubmit" name="save" value="Save"><br>
									</div>
								</form>
							</div>
	...
	<footer class="btm-foot">
		<i class="fa fa-copyright">mumu</i>
	</footer>
